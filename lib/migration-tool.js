...
const memberBlacklist = new Set(["get", "getItem"]);
 ...
 * @param {Node[]} stack
 */
AbstractMemberTransformation.prototype.onDetectProperty = function (name, parentType, node, parent, stack) {throw "not implemented"};
/**
 * @param {String} name
 ...
 * @param {Node[]}} stack
 */
AbstractMemberTransformation.prototype.onDetectMember = function (name, containingType, isUnsafe, node, parent, stack) {throw "not implemented"};
...
AbstractMemberTransformation.prototype.detect = function (node, parent, stack) {
  ...
  if (node.type === Syntax.Property) {
    ...
    if (type.guess && memberBlacklist.has(oldMemberName)) {
      return null;
    }
...
ChangeSignatureTransformation.prototype.onDetectMember = function (name, containingType, isUnsafe, node, parent, stack) {
